...
const doNotDelete = "[ ☆ | ♥ 𝗩𝗢𝗟𝗗𝗜𝗚𝗢 ✰𝐁𝐎𝐓 ♥ | ☆]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy
module.exports = {
	config: {
		name: "help",
		version: "1.17",
...
msg += `𝐅𝐛: ✰https://www.facebook.com/voldigo.anos ☆ `;
			await message.reply({
				body: msg,
			});
		} else {
