...
module.exports = {
	...
	langs: {
		...
		en: {
			help: "╭─────────────♦️"
				...
				+ "\n╰─────────────👀",
			help2: "%1├───────♦️"
				+ "\n│ » 𝗟𝗼𝗹, 𝗹𝗲 𝗯𝗼𝘁 𝗰𝗼𝗻𝘁𝗶𝗲𝗻𝘁 %2 𝗰𝗺𝗱𝘀 𝗾𝘂𝗶 𝗽𝗲𝘂𝘃𝗲𝗻𝘁 𝗲̂𝘁𝗿𝗲 𝘂𝘁𝗶𝗹𝗶𝘀𝗲́ 𝗽𝗼𝘂𝗿 𝗹𝗲 𝗺𝗼𝗺𝗲𝗻𝘁"
				+ "\n│ » 𝗲́𝗰𝗿𝗶𝘁 %3help <𝗻𝗼𝗺 𝗱𝗲 𝗹𝗮 𝗰𝗺𝗱> 𝗽𝗼𝘂𝗿 𝘃𝗼𝗶𝗿 𝗺𝗲𝘀 𝗱𝗲́𝘁𝗮𝗶𝗹𝘀 𝗲𝘁 𝗰𝗼𝗺𝗺𝗲𝗻𝘁 𝘂𝘁𝗶𝗹𝗶𝘀𝗲́ 𝗹𝗮 𝗰𝗺𝗱"
				+ "\n│ %4"
				+ "\n╰─────────────👀",
	...
	onStart: async function ({ message, args, event, threadsData, getLang, role, globalData }) {
		...
		// ———————————————— 𝘃𝗼𝗶𝗰𝗶 𝗹𝗮 𝗹𝗶𝘀𝘁𝗲 𝗱𝗲 𝘁𝗼𝘂𝘀 𝗺𝗲𝘀 𝗰𝗺𝗱𝘀  ——————————————— //
		...
		// ————————————————— 𝗜𝗻𝗳𝗼 𝘀𝘂𝗿 𝗹𝗮 𝗰𝗺𝗱 ————————————————— //
			...
			if (args[1]?.match(/^-g|guide|-u|usage$/)) {
				...
				formSendMessage.body = getLang(
					...
					aliasesString,
					aliasesThisGroup,
					configCommand.version,const fs = require("fs-extra");
const axios = require("axios");
const path = require("path");
const { getPrefix } = global.utils;
const { commands, aliases } = global.GoatBot;
